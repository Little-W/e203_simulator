...
sim: compile_c e203
	$(eval SIM_OPTIONS_COMMON := -DNO_TIMEOUT-DSIM_MODE)
	make run SIM_ROOT_DIR=${SIM_ROOT_DIR} DUMPWAVE=${DUMPWAVE} SIM_OPTIONS_COMMON=${SIM_OPTIONS_COMMON} SIM_TOOL=${SIM_TOOL} -C ${BUILD_DIR}
